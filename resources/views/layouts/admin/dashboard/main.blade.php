...
<div class="navbar navbar-inverse navbar-static-top">
    <div class="container " style="position: relative;">
     <button style="position: absolute;"> <img src="/images/usericon.png" alt="" height="50px" style="top: 1%; position:absolute; bottom: 0%;"></button>
...
<p style="color: #bbb; left: 80%;position: absolute; margin-top: 1.5%;">@yield('jobid')</p>
<br>
<p style="color: #bbb; left: 80%;position: absolute; margin-top: 1.5%;">@yield('email')</p>
<br><br>
